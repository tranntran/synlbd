...
seed = as.integer(commandArgs(trailingOnly = TRUE))
    ...
    tab$sic3[1] = sic3
    sic2 = floor(sic3/10)
    syn_data = read.csv(paste0("./output/", sic3, "/", sic3, "_syndata_swkng_logistic_seed", seed, ".csv"))
    ...
    output = paste0("./output/general_utility/pMSE_utility_syndata_swkng_emp.csv")
